...
public class Scenes {
    ...
    public static Scene scene6() {
        ...
        return new Scene().initAmbient(new Vec(1.0))
                .initCamera(new Point(0.0, 0.0, 2.0), new Vec(0.0, 0.0, -1.0), new Vec(1.0, 1.0, 0.0), 1.0).addLightSource(dirLight).addSurface(sphereSurface1).initName("scene6").initAntiAliasingFactor(1).initRenderRefarctions(true).initRenderReflections(true).initMaxRecursionLevel(6);
    }
    ...
    public static Scene scene7() {
        ...
        for (int i = 1; i < 10; i++) {
            Shape sphereShape_1 = new Sphere(new Point(i * 0.1, i * 0.1, i * 0.1), 0.1);
            Shape sphereShape_2 = new Sphere(new Point(-i * 0.1, i * 0.1, i * 0.1), 0.1);
            Shape sphereShape_3 = new Sphere(new Point(i * 0.1, -i * 0.1, i * 0.1), 0.1);
            Shape sphereShape_4 = new Sphere(new Point(-i * 0.1, -i * 0.1, i * 0.1), 0.1);
            Material sphereMat_1 = Material.getRandomMaterial();
            Material sphereMat_2 = Material.getRandomMaterial();
            Material sphereMat_3 = Material.getRandomMaterial();
            Material sphereMat_4 = Material.getRandomMaterial();
            Surface sphereSurface_1 = new Surface(sphereShape_1, sphereMat_1);
            Surface sphereSurface_2 = new Surface(sphereShape_2, sphereMat_2);
            Surface sphereSurface_3 = new Surface(sphereShape_3, sphereMat_3);
            Surface sphereSurface_4 = new Surface(sphereShape_4, sphereMat_4);

            scene.addSurface(sphereSurface_1);
            scene.addSurface(sphereSurface_2);
            scene.addSurface(sphereSurface_3);
